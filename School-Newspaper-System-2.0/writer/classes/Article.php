...
class Article extends Database {
     ...
     */
    public function createArticle($title, $content, $author_id, $category_id = null, $imagePath = null) {
     ...
     * Updates an article.
     */
    public function updateArticle($id, $title, $content, $category_id = null, $imagePath = null) {
        if ($imagePath !== null) {
            $sql = "UPDATE articles 

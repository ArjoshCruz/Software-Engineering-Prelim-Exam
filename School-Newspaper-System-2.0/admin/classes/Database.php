...
class Database {
    ...
    private $db = 'school-newspaper-system-2.0';
    private $user = 'root';
    private $pass = '';
    ...
    /**
     * Exposes the underlying PDO instance for legacy/direct queries.
     * Prefer using the provided query helpers when possible.
     * @return PDO
     */
